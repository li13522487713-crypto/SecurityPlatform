  ...
  routes: [
    ...
    { path: "/", redirect: "/console" },
    {
      ...
      children: [
        ...
        { path: "console/runtime-preview", name: "console-runtime-preview", component: () => import("@/pages/console/RuntimePreviewPage.vue") },
        { path: "console/connectors/online-apps", name: "console-connectors-online-apps", component: () => import("@/pages/console/ConnectorOnlineAppsPage.vue") },
        { path: "console/connectors/list", name: "console-connectors-list", component: () => import("@/pages/console/ConnectorListPage.vue") },
        ...
        // ── 应用工作区（使用 AppWorkspaceLayout） ──
        {
          ...
          children: [
            ...
            { path: "data/shared-designer", name: "app-data-shared-designer", component: () => import("@/pages/dynamic/SharedDesignerPage.vue") },

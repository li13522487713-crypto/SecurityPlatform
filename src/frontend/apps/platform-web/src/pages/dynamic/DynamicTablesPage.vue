                  ...
                  <template #bodyCell="{ column, record }">
                    ...
                    <template v-else-if="column.key === 'allowNull'">
                      <a-tag :color="record.allowNull ? 'default' : 'red'">
                        {{ record.allowNull ? t("dynamic.yes") : t("dynamic.no") }}
                      </a-tag>
                    </template>
                  </template>
                </a-table>
...
const handleModeChange = (key: string) => {
  ...
  if (key === "relations") {
    ...
    void router.push(`/apps/${selectedAppId.value}/data/designer`);
  } else if (key === "changes") {
    activeMode.value = "tables";
    message.info(t("dynamic.modeChangesPending"));
  }
};
...
const handleCreateTable = async () => {
  ...
  try {
    ...
    const fields: DynamicFieldDefinition[] = [
      {
        name: "id",
        displayName: t("dynamic.defaultFieldId"),
        fieldType: "Long",
        allowNull: false,
        isPrimaryKey: true,
    ...
    if (createForm.template === "basic" || createForm.template === "approval") {
      fields.push({
        name: "name",
        displayName: t("dynamic.defaultFieldName"),
        fieldType: "String",
        length: 128,
        allowNull: false,
        isPrimaryKey: false,
    ...
    if (createForm.template === "dict") {
      fields.push(
        {
          name: "code",
          displayName: t("dynamic.defaultFieldCode"),
          fieldType: "String",
          length: 64,
          allowNull: false,
          isPrimaryKey: false,
        ...
        {
          name: "label",
          displayName: t("dynamic.defaultFieldLabel"),
          fieldType: "String",
          length: 128,
          allowNull: false,
          isPrimaryKey: false,
        ...
        {
          name: "sort_order",
          displayName: t("dynamic.defaultFieldSortOrder"),
          fieldType: "Int",
          allowNull: true,
          isPrimaryKey: false,
          isAutoIncrement: false,
    ...
    if (createForm.includeSystemFields) {
      fields.push(
        {
          name: "created_at",
          displayName: t("dynamic.defaultFieldCreatedAt"),
          fieldType: "DateTime",
          allowNull: true,
          isPrimaryKey: false,
          isAutoIncrement: false,
        ...
        {
          name: "updated_at",
          displayName: t("dynamic.defaultFieldUpdatedAt"),
          fieldType: "DateTime",
          allowNull: true,
          isPrimaryKey: false,
          isAutoIncrement: false,
    ...
    if (createForm.includeExtraSystemFields && createForm.includeSystemFields) {
      fields.push(
        {
          name: "created_by",
          displayName: t("dynamic.defaultFieldCreatedBy"),
          fieldType: "Long",
          allowNull: true,
          isPrimaryKey: false,
          isAutoIncrement: false,
        ...
        {
          name: "updated_by",
          displayName: t("dynamic.defaultFieldUpdatedBy"),
          fieldType: "Long",
          allowNull: true,
          isPrimaryKey: false,
          isAutoIncrement: false,
        ...
        {
          name: "is_deleted",
          displayName: t("dynamic.defaultFieldIsDeleted"),
          fieldType: "Bool",
          allowNull: false,
          isPrimaryKey: false,
          isAutoIncrement: false,

    ...
    <a-row :gutter="24">
      <a-col :span="16">
        ...
        <a-card class="workbench-card" :bordered="false">
          ...
          <template #extra>
            <a-button type="link" @click="$router.push('/console/alert')">{{ t("home.viewAll") }}</a-button>
          </template>
...
const organizationEntriesSource: QuickEntrySource[] = [
  { titleKey: "home.quickUsersTitle", path: "/console/settings/org/users", permissions: ["users:view"] },
  { titleKey: "home.quickRolesTitle", path: "/console/settings/auth/roles", permissions: ["roles:view"] },
  { titleKey: "home.quickMenusTitle", path: "/console/settings/auth/menus", permissions: ["menus:view"] },
  { titleKey: "home.quickProjectsTitle", path: "/console/settings/projects", permissions: ["projects:view"] }
];

const businessEntriesSource: QuickEntrySource[] = [
  { titleKey: "home.quickDatasourcesTitle", path: "/console/settings/system/datasources", permissions: ["*:*:*"] },
  { titleKey: "home.quickWorkflowTitle", path: "/console/workflow/designer", permissions: ["workflow:view"] }
];

const securityEntriesSource: QuickEntrySource[] = [
  { titleKey: "home.quickAssetsTitle", path: "/console/assets", permissions: ["assets:view"] },
  { titleKey: "home.quickAuditTitle", path: "/console/audit", permissions: ["audit:view"] },
  { titleKey: "home.quickAlertCenterTitle", path: "/console/alert", permissions: ["alert:view"] },
  { titleKey: "home.quickApprovalTitle", path: "/console/approval/flows", permissions: ["approval:flow:view", "approval:flow:create"] }
];
...
const quickEntries = computed(() =>
  [
    ...organizationEntriesSource.filter((e) => canAccess(e.permissions)),
    ...businessEntriesSource.filter((e) => canAccess(e.permissions)),
    ...securityEntriesSource.filter((e) => canAccess(e.permissions))
  ]
    .slice(0, 8)

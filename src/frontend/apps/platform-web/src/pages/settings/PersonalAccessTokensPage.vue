...
async function loadData() {
  ...
  try {
    ...
    message.error(error instanceof Error ? error.message : t("settings.pat.loadFailed"));
  } finally {
    loading.value = false;
  }
}
...
async function submitForm() {
  ...
  try {
    ...
    message.error(error instanceof Error ? error.message : t("settings.pat.submitFailed"));
  } finally {
...
async function handleRevoke(id: number) {
  try {
    ...
    message.error(error instanceof Error ? error.message : t("settings.pat.revokeFailed"));
  }
}

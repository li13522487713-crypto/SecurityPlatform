export default {
  ...
  appLogin: {
    ...
    mfaRequired: "Multi-factor authentication required. Enter code and try again.",
  ...
  sidebar: {
    ...
    reports: "Reports",
    dashboards: "Dashboards",
    visualization: "Runtime Monitoring",
  ...
  dynamicTable: {
    ...
    selectTableFirst: "Select a table from the left panel",
    emptyNoTables: "No tables yet. Click below to create the first one.",
    createFirstTable: "Create First Table",
    searchSidebarPlaceholder: "Search tables...",
    tableDirectory: "Table Directory",
    noDataFound: "No matching tables found",
    ...
    fieldListOverview: "Fields Overview",
    ...
    createTableModalTitle: "New Data Table",
    tableNameLabel: "Display Name",
    tableNamePlaceholder: "Enter display name",
    tableKeyLabel: "Table Key",
    tableKeyPlaceholder: "e.g. order_header",
    tableKeyRule: "Start with a letter, only letters/digits/underscores, 2-64 chars",
    descriptionLabel: "Description",
    tableDescPlaceholder: "Purpose of this table (optional)",
    templateLabel: "Template",
    templateBasic: "Basic",
    templateApproval: "Approval",
    templateDict: "Dictionary",
    systemFieldsLabel: "Include system fields (created_at, updated_at)",
    systemFieldsHelp: "Automatically record creation and modification time",
    extraSystemFieldsLabel: "Include extended fields (created_by, updated_by, is_deleted)",
    extraSystemFieldsHelp: "Track operator and soft-delete flag",
    ...
    loadTableDetailFailed: "Failed to load table details",

    deleteBlockedTitle: "Cannot Delete",
    deleteBlockedHint: "This table has the following dependencies. Please remove them before deleting:",
    deleteBlockedTip: "Dependencies exist, cannot delete directly",
    blockerType: "Type",
    blockerName: "Name",
    blockerPath: "Path",

    defaultFieldId: "Primary Key ID",
    ...
    defaultFieldIsDeleted: "Is Deleted",

    designPageTitle: "Field Design",
    ...
    alterSuccess: "Schema changes applied",
    alterFailed: "Failed to apply changes",
    previewTitle: "Change Preview",
    previewSqlScripts: "SQL statements to execute",
    previewRollback: "Rollback hint",
    loadFieldsFailed: "Failed to load field definitions",

    recordsTitle: "Data Browser",
    ...
    noRecords: "No data",
    createRecordSuccess: "Record created",

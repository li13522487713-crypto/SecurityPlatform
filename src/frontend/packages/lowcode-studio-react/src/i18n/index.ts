...
export const STUDIO_MESSAGES = {
  'zh-CN': {
    ...
    'lowcode_studio.workflow.deleteUnavailable': '宿主未注入 deleteWorkflow 能力，无法在此删除工作流。',
    'lowcode_studio.workflow.deleteConfirmTitle': '删除工作流',
    'lowcode_studio.workflow.deleteConfirmContent': '将删除工作流并解除当前应用绑定，此操作不可撤销',
  ...
  'en-US': {
    ...
    'lowcode_studio.workflow.deleteUnavailable': 'The host did not provide deleteWorkflow support.',
    'lowcode_studio.workflow.deleteConfirmTitle': 'Delete workflow',
    'lowcode_studio.workflow.deleteConfirmContent': 'This will delete the workflow and unbind it from the current app. This action cannot be undone',

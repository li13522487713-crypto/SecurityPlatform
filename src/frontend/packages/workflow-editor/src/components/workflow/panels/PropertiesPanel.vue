...
import type { NodeSchema, NodeTypeMetadata } from '../../../types'
import StartNodeForm from '../forms/StartNodeForm.vue'
import EndNodeForm from '../forms/EndNodeForm.vue'
import SelectorNodeForm from '../forms/SelectorNodeForm.vue'
import LoopNodeForm from '../forms/LoopNodeForm.vue'
import BatchNodeForm from '../forms/BatchNodeForm.vue'
import BreakNodeForm from '../forms/BreakNodeForm.vue'
import ContinueNodeForm from '../forms/ContinueNodeForm.vue'
import LlmNodeForm from '../forms/LlmNodeForm.vue'
import IntentDetectorNodeForm from '../forms/IntentDetectorNodeForm.vue'
import QuestionAnswerNodeForm from '../forms/QuestionAnswerNodeForm.vue'
import CodeNodeForm from '../forms/CodeNodeForm.vue'
import TextProcessorNodeForm from '../forms/TextProcessorNodeForm.vue'
import JsonSerializationNodeForm from '../forms/JsonSerializationNodeForm.vue'
import JsonDeserializationNodeForm from '../forms/JsonDeserializationNodeForm.vue'
import VariableAggregatorNodeForm from '../forms/VariableAggregatorNodeForm.vue'
import AssignVariableNodeForm from '../forms/AssignVariableNodeForm.vue'
import PluginNodeForm from '../forms/PluginNodeForm.vue'
import HttpRequestNodeForm from '../forms/HttpRequestNodeForm.vue'
import SubWorkflowNodeForm from '../forms/SubWorkflowNodeForm.vue'
import KnowledgeSearchNodeForm from '../forms/KnowledgeSearchNodeForm.vue'
import KnowledgeWriteNodeForm from '../forms/KnowledgeWriteNodeForm.vue'
import LtmNodeForm from '../forms/LtmNodeForm.vue'
import DatabaseQueryNodeForm from '../forms/DatabaseQueryNodeForm.vue'
import DatabaseInsertNodeForm from '../forms/DatabaseInsertNodeForm.vue'
import DatabaseUpdateNodeForm from '../forms/DatabaseUpdateNodeForm.vue'
import DatabaseDeleteNodeForm from '../forms/DatabaseDeleteNodeForm.vue'
import DatabaseCustomSqlNodeForm from '../forms/DatabaseCustomSqlNodeForm.vue'
import ConversationNodeForm from '../forms/ConversationNodeForm.vue'
import ConversationHistoryNodeForm from '../forms/ConversationHistoryNodeForm.vue'
import MessageNodeForm from '../forms/MessageNodeForm.vue'
import IoNodeForm from '../forms/IoNodeForm.vue'
import GenericNodeForm from '../forms/GenericNodeForm.vue'

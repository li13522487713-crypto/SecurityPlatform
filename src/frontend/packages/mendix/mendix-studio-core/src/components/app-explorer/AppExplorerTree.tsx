...
import type { ExplorerTreeNode } from "./AppExplorerContainer";
...
interface AppExplorerTreeProps {
  ...
  onCreateMicroflow?: (node: ExplorerTreeNode) => void;
  onCreateFolder?: (node: ExplorerTreeNode) => void;
  onRenameFolder?: (node: ExplorerTreeNode) => void;
  onRenameMicroflow?: (node: ExplorerTreeNode) => void;
  onDuplicateMicroflow?: (node: ExplorerTreeNode) => void;
...
function renderContextMenu(input: {
  ...
  const { node, onSelect, onRefreshMicroflows, onCreateMicroflow, onCreateFolder, onRenameFolder, onRenameMicroflow, onDuplicateMicroflow, onViewMicroflowReferences, onDeleteMicroflow } = input;
...
function ExplorerTreeNodeView({
  ...
  const contextMenu = renderContextMenu({ node, onSelect, onRefreshMicroflows, onCreateMicroflow, onCreateFolder, onRenameFolder, onRenameMicroflow, onDuplicateMicroflow, onViewMicroflowReferences, onDeleteMicroflow });
    ...
    <div>
      ...
      {open && hasChildren && node.children?.map(child => (
        <ExplorerTreeNodeView
          ...
          onCreateMicroflow={onCreateMicroflow}
          onCreateFolder={onCreateFolder}
          onRenameFolder={onRenameFolder}
          onRenameMicroflow={onRenameMicroflow}
          onDuplicateMicroflow={onDuplicateMicroflow}

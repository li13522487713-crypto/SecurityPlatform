...
const activityDefinitions: Array<Parameters<typeof activityEntry>[0]> = [
  ...
  { activityType: "showMessage", title: "Show Message", titleZh: "显示消息", activityCategory: "client", config: { messageExpression: { id: "expr-message", language: "plainText", text: "", referencedVariables: [] } }, description: "Displays a blocking or non-blocking message.", supportsErrorHandling: false },
  ...
  { activityType: "logMessage", title: "Log Message", titleZh: "记录日志", activityCategory: "logging", config: { logLevel: "info", messageExpression: { id: "expr-log", language: "plainText", text: "Order processed", referencedVariables: [] } }, description: "Writes an application log entry.", supportsErrorHandling: false },
  ...
  { activityType: "counter", title: "Counter", titleZh: "计数器", activityCategory: "metrics", config: { metricName: "", valueExpression: { id: "expr-counter", language: "mendix", text: "1", referencedVariables: [] } }, description: "Sets or increases a custom counter metric.", supportsErrorHandling: false },
  ...
  { activityType: "gauge", title: "Gauge", titleZh: "仪表指标", activityCategory: "metrics", config: { metricName: "", valueExpression: { id: "expr-gauge", language: "mendix", text: "0", referencedVariables: [] } }, description: "Sets a gauge metric value.", supportsErrorHandling: false },
...
export const microflowNodeRegistries: MicroflowNodeRegistryEntry[] = [
  ...
  createEntry({
    ...
    availability: "supported",
    availabilityReason: undefined,
    defaultConfig: { expression: { id: "expr-decision", language: "mendix", text: "", referencedVariables: [] }, resultType: "Boolean" },

...
const supportedFunctionRules: Record<string, SupportedFunctionRule> = {
  ...
  htmlEncode: { minArgs: 1, maxArgs: 1, category: "string", returnKind: "string" },
  ...
  addHours: { minArgs: 2, maxArgs: 2, category: "dateTime", returnKind: "dateTime" },
  addMinutes: { minArgs: 2, maxArgs: 2, category: "dateTime", returnKind: "dateTime" },
  addSeconds: { minArgs: 2, maxArgs: 2, category: "dateTime", returnKind: "dateTime" },
  addWeeks: { minArgs: 2, maxArgs: 2, category: "dateTime", returnKind: "dateTime" },
  addQuarters: { minArgs: 2, maxArgs: 2, category: "dateTime", returnKind: "dateTime" },
  getYear: { minArgs: 1, maxArgs: 1, category: "dateTime", returnKind: "integer" },
  getMonth: { minArgs: 1, maxArgs: 1, category: "dateTime", returnKind: "integer" },
  getDay: { minArgs: 1, maxArgs: 1, category: "dateTime", returnKind: "integer" },
  getHour: { minArgs: 1, maxArgs: 1, category: "dateTime", returnKind: "integer" },
  getMinute: { minArgs: 1, maxArgs: 1, category: "dateTime", returnKind: "integer" },
  getSecond: { minArgs: 1, maxArgs: 1, category: "dateTime", returnKind: "integer" },
  getDayOfWeek: { minArgs: 1, maxArgs: 1, category: "dateTime", returnKind: "integer" },
  dateDiff: { minArgs: 3, maxArgs: 3, category: "dateTime", returnKind: "integer" },
  currentDateTime: { minArgs: 0, maxArgs: 0, category: "utility", returnKind: "dateTime" },
  parseInteger: { minArgs: 1, maxArgs: 1, category: "string", returnKind: "integer" },
  parseDecimal: { minArgs: 1, maxArgs: 1, category: "string", returnKind: "decimal" },
  formatDecimal: { minArgs: 2, maxArgs: 2, category: "utility", returnKind: "string" },
};

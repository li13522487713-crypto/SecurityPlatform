...
const router = createRouter({
  ...
  routes: [
    ...
    { path: "/console/debug", name: "console-debug-layer", component: CozeDebugPage, meta: { requiresAuth: true, title: "调试层", titleKey: "route.consoleDebugLayer", requiresPermission: "debug:view" } },

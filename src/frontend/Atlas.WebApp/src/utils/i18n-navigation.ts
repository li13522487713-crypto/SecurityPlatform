...
const titleKeyByPath: Record<string, string> = {
  ...
  "/apps/:appId/logic-flow/designer": "route.logicFlowDesigner",
  "/apps/:appId/logic-flow/studio": "route.backendCapabilityStudio",
  "/apps/:appId/logic-flow/executions": "route.logicFlowExecutions",
  "/apps/:appId/logic-flow/executions/:id": "route.logicFlowExecutionDetail",
  "/apps/:appId/logic-flow/executions/:id/timeline": "route.logicFlowExecutionTimeline",
  "/apps/:appId/logic-flow/governance": "route.logicFlowGovernance",
  "/apps/:appId/logic-flow/plugins": "route.logicFlowPlugins",
  "/apps/:appId/data/views/designer": "route.viewDesigner",

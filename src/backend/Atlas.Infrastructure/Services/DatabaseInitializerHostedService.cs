...
public sealed class DatabaseInitializerHostedService : IHostedService
{
    ...
    private async Task<BootstrapReport> RunCoreAsync(CancellationToken cancellationToken)
    {
            ...
            bool IsHidden)[]
        {
            ...
            ("模板市场", "/lowcode/templates", "/lowcode", 23, "C", "lowcode/TemplateMarketPage", "file-text", PermissionCodes.AppsView, null, false, true, "0", "0", PermissionCodes.AppsView, false),
            ("插件市场", "/lowcode/plugin-market", "/lowcode", 24, "C", "lowcode/PluginMarketPage", "shopping", PermissionCodes.AppsView, null, false, true, "0", "0", PermissionCodes.AppsView, false),
            ("消息中心", "/lowcode/messages", "/lowcode", 25, "C", "lowcode/MessageCenterPage", "message", PermissionCodes.NotificationView, null, false, true, "0", "0", PermissionCodes.NotificationView, false),
            ("AI 助手", "/lowcode/ai-assistant", "/lowcode", 26, "C", "lowcode/AiAssistantPage", "robot", PermissionCodes.AppsView, null, false, true, "0", "0", PermissionCodes.AppsView, false),
            ("流程监控", "/lowcode/process-monitor", "/lowcode", 27, "C", "lowcode/ProcessMonitorPage", "fund-view", PermissionCodes.ApprovalFlowView, null, false, true, "0", "0", PermissionCodes.ApprovalFlowView, false),
            ("回写监控", "/monitor/writeback-failures", "/lowcode", 28, "C", "lowcode/WritebackMonitorPage", "warning", PermissionCodes.SystemAdmin, null, false, true, "0", "0", PermissionCodes.SystemAdmin, false),
            ("迁移管理", "/lowcode/migrations", "/lowcode", 29, "C", "lowcode/DynamicMigrationsPage", "database", PermissionCodes.SystemAdmin, null, false, true, "0", "0", PermissionCodes.SystemAdmin, false),
            ("包管理", "/lowcode/packages", "/lowcode", 30, "C", "lowcode/PackagesPage", "deployment-unit", PermissionCodes.AppsView, null, false, true, "0", "0", PermissionCodes.AppsView, false),
            ("报表管理", "/lowcode/reports", "/lowcode", 31, "C", "lowcode/ReportsPage", "bar-chart", PermissionCodes.AppsView, null, false, true, "0", "0", PermissionCodes.AppsView, false),
            ("仪表盘管理", "/lowcode/dashboards", "/lowcode", 32, "C", "lowcode/DashboardsPage", "dashboard", PermissionCodes.AppsView, null, false, true, "0", "0", PermissionCodes.AppsView, false),

...
/// <summary>
/// Lowcode 场景复用 AiAppResourceBinding 表，但 appId 语义固定为 AppDefinition.Id。
/// 不允许再通过 AiAppRepository 校验，否则会把低代码应用误判为不存在。
/// </summary>
public sealed class LowCodeAppResourceBindingService : ILowCodeAppResourceBindingService
{
    ...
    public LowCodeAppResourceBindingService(

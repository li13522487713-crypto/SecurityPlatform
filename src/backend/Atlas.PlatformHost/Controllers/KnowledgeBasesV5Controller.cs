...
/// <summary>
/// 知识库专题（v5 §32-44）扩展接口：jobs / bindings / permissions / versions / retrieval-logs / provider-configs
/// 与表格、图片、统一检索协议；与既有 <see cref="KnowledgeBasesController"/> 共用 <c>api/v1/knowledge-bases</c> 前缀。
/// </summary>
[ApiController]

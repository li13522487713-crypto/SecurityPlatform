...
/// <summary>
/// 应用资源聚合（M07 S07-3 设计态 v1，K5/X1 增加 App 资源绑定 CRUD）。
/// </summary>
[ApiController]
...
public sealed class LowCodeAppResourcesController : ControllerBase
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var byTypeKeys = bindings
            .GroupBy(b => b.ResourceType, StringComparer.OrdinalIgnoreCase)
            .ToDictionary(
                g => g.Key,
                g => g.Select(b => b.ResourceId.ToString()).ToHashSet(StringComparer.OrdinalIgnoreCase),

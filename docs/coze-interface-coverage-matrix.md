...
| publish manage / version detail | `app-web` / `@coze-arch/bot-api` | intelligenceApi | `GetPublishRecordDetail` | `POST /api/intelligence_api/publish/publish_record_detail` | `project_id` | `publish_record_id` | `data.publish_record_id`, `data.version_number`, `data.publish_status`, `data.connector_publish_result[]` | Partial | 是 | 部分 | 是 | 是 |
| publish manage / version list | `app-web` / `@coze-arch/bot-api` | intelligenceApi | `GetPublishRecordList` | `POST /api/intelligence_api/publish/publish_record_list` | `project_id` | 无 | `data[].publish_record_id`, `data[].version_number`, `data[].publish_status` | Partial | 是 | 部分 | 是 | 是 |
| publish manage / runtime log | `app-web` | intelligenceApi | `GetPublishLogList` | `POST /api/intelligence_api/publish/log_list` | `project_id` | `session_id`, `workflow_id`, `page_index`, `page_size` | `data.log_list[]`, `data.total`, `data.has_more` | OK | 是 | 是 | 是 | 是 |
| publish manage / trigger list | `app-web` | intelligenceApi | `GetPublishTriggerList` | `POST /api/intelligence_api/publish/trigger_list` | `project_id` | 无 | `data.trigger_list[]`, `data.total` | OK | 是 | 是 | 是 | 是 |
| publish manage / trigger action | `app-web` | intelligenceApi | `CreatePublishTrigger` | `POST /api/intelligence_api/publish/trigger_create` | `project_id` | `name`, `trigger_type`, `config_json`, `enabled` | `data.trigger` | OK | 是 | 是 | 是 | 是 |
| publish manage / trigger action | `app-web` | intelligenceApi | `UpdatePublishTrigger` | `POST /api/intelligence_api/publish/trigger_update` | `project_id`, `trigger_id` | `name`, `trigger_type`, `config_json`, `enabled` | `data.trigger` | OK | 是 | 是 | 是 | 是 |
| publish manage / trigger action | `app-web` | intelligenceApi | `DeletePublishTrigger` | `POST /api/intelligence_api/publish/trigger_delete` | `project_id`, `trigger_id` | 无 | `data.deleted`, `data.trigger_id` | OK | 是 | 是 | 是 | 是 |
| workspace settings / channels | `app-web` | workspaceApi | `ListWorkspacePublishChannels` | `GET /api/v1/workspaces/{workspaceId}/publish-channels` | `workspaceId` | `keyword`, `pageIndex`, `pageSize` | `data.items[]`, `data.total` | OK | 是 | 是 | 是 | 是 |
| workspace settings / channels | `app-web` | workspaceApi | `ReauthorizeWorkspacePublishChannel` | `POST /api/v1/workspaces/{workspaceId}/publish-channels/{channelId}/reauth` | `workspaceId`, `channelId` | 无 | `data.success` | OK | 是 | 是 | 是 | 是 |
| workspace settings / channels | `app-web` | workspaceApi | `DeleteWorkspacePublishChannel` | `DELETE /api/v1/workspaces/{workspaceId}/publish-channels/{channelId}` | `workspaceId`, `channelId` | 无 | `data.success` | OK | 是 | 是 | 是 | 是 |
| workspace projects / folders | `app-web` | workspaceApi | `ListWorkspaceFolders` | `GET /api/v1/workspaces/{workspaceId}/folders` | `workspaceId` | `keyword`, `pageIndex`, `pageSize` | `data.items[]`, `data.total` | OK | 是 | 是 | 是 | 是 |
| workspace projects / folders | `app-web` | workspaceApi | `CreateWorkspaceFolder` | `POST /api/v1/workspaces/{workspaceId}/folders` | `workspaceId`, `name` | `description` | `data.id`, `data.folderId` | OK | 是 | 是 | 是 | 是 |
| workspace projects / folders | `app-web` | workspaceApi | `MoveWorkspaceItemToFolder` | `POST /api/v1/workspaces/{workspaceId}/folders/{folderId}/items` | `workspaceId`, `folderId`, `itemType`, `itemId` | 无 | `data.success` | OK | 是 | 是 | 是 | 是 |

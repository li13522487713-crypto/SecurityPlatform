...
- `src/backend/Atlas.AppHost/Controllers/AiDatabasesController.cs`

AppHost 是权威 Web 宿主。调整创建流程时保持现有 CRUD、records、bulk、imports、mode、channel-config 兼容。
...
- 控制器：`src/backend/Atlas.AppHost/Controllers/TenantDataSourcesController.cs`
